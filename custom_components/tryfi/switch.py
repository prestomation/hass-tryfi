...
class TryFiLostModeSwitch(CoordinatorEntity, SwitchEntity):
    ...
    def available(self) -> bool:
        ...
        return (
            ...
            and hasattr(self.pet, "device")
            and self.pet.device is not None
        )
    ...
    async def async_turn_on(self, **kwargs: Any) -> None:
        ...
        await self.hass.async_add_executor_job(
            self.pet.setLostDogMode, self.coordinator.data.session, True
        )
    ...
    async def async_turn_off(self, **kwargs: Any) -> None:
        ...
        await self.hass.async_add_executor_job(
            self.pet.setLostDogMode, self.coordinator.data.session, False
        )
